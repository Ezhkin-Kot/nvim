...
-- DAP
-- stylua: ignore start
map("n", "<leader>du", function() require("dapui").open() end, { desc = "DAP UI Open" })
map("n", "<leader>dc", function() require("dapui").close() end, { desc = "DAP UI Close" })
...
-- typst-preview
map("n", "<leader>tp", function() vim.cmd("TypstPreview") end, { desc = "Typst Preview Open" })
map("n", "<leader>tc", function() vim.cmd("TypstPreviewStop") end, { desc = "Typst Preview Close" })
